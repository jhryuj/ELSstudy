...
function indexROIs(data_dir,subj,mrVista_dir,roilist_file)
    ...
    outroi_dir = fullfile(data_dir,subj,'glm_nsubjSpace_rois'); if ~exist(outroi_dir), mkdir(outroi_dir);,end
