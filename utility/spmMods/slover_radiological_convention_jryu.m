function [o, others] = slover_radiological_convention_jryu(params, others, varargin)
...
myclass = 'slover_radiological_convention';

img_range_struct = struct('range', [0 6]);

% Default object structure
defstruct = struct('img', struct('cmap','hot', 'range', [0 6]), ...
           'transform', 'axial', ...
           'slicedef', [], ... 
           'slices', [], ...
           'figure', [], ...
...
%             o = pr_basic_ui_RK(others, varargin{:});
            
            o = pr_basic_ui_jryu(others, varargin{:});
